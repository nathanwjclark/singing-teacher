...
import { MELODY_HOP_MS, MELODY_STABLE_MS } from '../../evaluation/learning/melody.ts'
...
export function learningInstruction(protocol: LearningProtocol, arm: LearningArm, phase: LearningAttempt['phase']) {
  ...
  if (phase === 'transfer' && protocol.melody) return 'Sing the frozen short melody from memory using the declared words or vowel, without consulting your cue or mnemonic. Begin when ready, then leave at least 300 ms of silence before stopping.'
