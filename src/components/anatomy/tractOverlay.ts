 ...
 * plate's native left-facing coordinates. Airway and tongue are separate surfaces driven by the same pose.
 */
export function createTractOverlay(layer: 'airway' | 'tongue') {
  ...
  if (layer === 'airway') {
    ...
    // lower SVG. The airway follows jaw/head motion independently of the tongue.
    ...
    fill('M 166 159 C 156 144 176 129 195 132 C 208 133 216 137 223 139 C 217 140 207 151 194 154 C 181 154 178 165 166 159 Z', '#bd7788b8', '#e5a3ad', .8);
  }
