export function ProbeCaptureGuide() {
  return <details className="probe-guide">
    ...
    <ol>
      ...
      <li><strong>Analyze in the app.</strong> Use Pull iPhone over USB while the phone is unlocked, then Analyze latest probe below. The app retains and verifies the original linked capture and probe bytes. Fit probe with voice model becomes available when the measured calibration and fitting profile prerequisites are satisfied. Changing placement, volume or route requires new calibration records.</li>
    </ol>
