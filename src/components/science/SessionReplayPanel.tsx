 ...
 return <section className="session-replay" aria-label="Scientific session replay">
  ...
  <div className="session-recomputation" aria-label="Numerical score verification">
   ...
   {verification?.report&&<>
    ...
    <p>Failed means the recomputed score differs or the retained evidence is inconsistent. Unavailable means the original score, frame or receipt is missing; nothing is reconstructed. Unsupported means the operation is not a score, its frozen scoring code differs from this computer's, or this computer cannot run the scorer now (Node, extractor or native engine).</p>
