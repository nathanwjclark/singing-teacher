...
export interface ScientificResult {
 ...
 anatomy:Record<string,number>;referenceAnatomy:Record<string,number>;fitDiscrepancy:number;baselineDiscrepancy:number;interpretation:string;geometryRole:string;forecastRole:string;
