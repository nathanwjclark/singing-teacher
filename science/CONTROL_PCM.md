...
- The export still has a 24 MiB bound. At about 0.29 MB per Astra round the app loop reaches it after roughly 80 more rounds in one session; the export then comes back `partial` without the replay.
