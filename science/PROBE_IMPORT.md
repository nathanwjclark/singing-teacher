...
Physical/human evidence requires calibration kind `measured`; fixture declarations stay `synthetic-fixture`. Verification proves supplied bytes and bindings, **not authenticity or physical sufficiency** of calibration. Route processing and calibration evidence require independent scientific assessment.
