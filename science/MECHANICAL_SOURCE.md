...
The off-grid, equal-budget comparison is in [evaluation/wave3/source](../evaluation/wave3/source/README.md). Its first frozen revision is **inconclusive** (synthetic evidence). The geometric glottis won 4 of 8 held-out cases on the primary score and 6 of 8 without the pitch term, the two-mass model 1 and 0, but 4 of the 6 evaluable cases came from geometric generators, half the tract support was lost to the analysis floor and one two-mass generator had no fit. On the one evaluable two-mass generator, two-mass tied once and lost once on the primary score. It gives no support for making two-mass the default. Physical-device measurements, validation against vocal-fold imaging or contact instrumentation, recovery of more physiological parameters and calibrated uncertainty remain open.
