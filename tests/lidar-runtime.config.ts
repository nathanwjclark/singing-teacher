...
export default workerBackedConfig({spec:'lidar-runtime.spec.ts',prefix:'LIDAR',port:5209,sciencePort:8809,data:'.local-e2e-lidar',timeout:180_000,prepare:'tests/fixtures/prepare_lidar_runtime.py',appData:'app',scienceData:'worker',env:{LIDAR_FUSION_ENABLED:'1'}});
