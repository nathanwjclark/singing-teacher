...
test('LiDAR export binds original archive and authoritative adoption, including rejected attempts',async t=>{
 ...
 const scientific=replay(),result={status:'ranked',with_depth_order:['candidate'],rankings:[]};
 ...
 await put('lidar-fits/fit-one/experimental-declaration.json',{sourceKind:'development-fixture'});
