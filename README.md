...
- **Movement map:** 165 real skeletal and muscle meshes from Z-Anatomy, derived from BodyParts3D, rendered in 3D with cartoony eyeballs and a parted haircut adapted from the CC0 MakeHuman short04 mesh and its original strand texture in muscle mode. Hair provenance and license are linked beneath the model and in `public/models/hair/ATTRIBUTION.md`. The mirrored model follows estimated head and body movement. Jaw and neck muscle meshes deform between weighted skull, jaw, and chest attachments; chin muscles follow the jaw. Independent shoulder joints drive the clavicles, upper arms, and attached deltoid, trapezius, and chest muscles. Facial blendshapes animate brow raises, blinks, cheek motion, and lip expressions. This is illustrative rigging, not a physiological muscle simulation. Recent coaching cues collect into up to six selectable tiles, ordered by newest onset or recurrence. Tiles distinguish currently present cues from recent observations, and expire 45 seconds after their last observation. Select a coaching card to explore its associated muscles; drag to orbit the model.
