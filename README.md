...
- **Movement map:** 165 real skeletal and muscle meshes from Z-Anatomy, derived from BodyParts3D, rendered in 3D with cartoony eyeballs and a fine-strand textured hairstyle in muscle mode. The mirrored model follows estimated head and body movement. Jaw and neck muscle meshes deform between weighted skull, jaw, and chest attachments; chin muscles follow the jaw. This is illustrative rigging, not a physiological muscle simulation. Recent coaching cues collect into up to six selectable tiles, ordered by newest onset or recurrence. Tiles distinguish currently present cues from recent observations, and expire 45 seconds after their last observation. Select a coaching card to explore its associated muscles; drag to orbit the model.
