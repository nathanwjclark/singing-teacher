...
For a single green label, click **Freeze frame & label tip**, then click the actual visible tip on the frozen image. Green marks your manual annotation and never appears automatically in live mode.
