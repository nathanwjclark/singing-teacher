...
// running developer app, its private captures or a provider credential.
const port = 5190;
export default defineConfig({
  ...
  webServer: {
    ...
    env: { PORT: String(port), LOCAL_DATA_DIR: '.local-e2e-data', OPENAI_ENV_FILE: '/dev/null', OPENAI_API_KEY: '' },
